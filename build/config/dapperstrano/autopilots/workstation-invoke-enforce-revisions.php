...
cd dapper$timeDrop
git show HEAD:build/config/dapperstrano/autopilots/workstation-node-install-enforce-revisions.php > /tmp/workstation-node-install-enforce-revisions.php
rm -rf /tmp/dapper$timeDrop
cd /tmp/
sudo dapperstrano autopilot execute workstation-node-install-enforce-revisions.php
sudo chown -R www-data /opt/jrush/jrush/current/src
sudo rm workstation-node-install-enforce-revisions.php
SSHDATA;
  }
