...
cd dapper$timeDrop
git show HEAD:build/config/dapperstrano/autopilots/workstation-node-install-code-data.php > /tmp/workstation-node-install-code-data.php
rm -rf /tmp/dapper$timeDrop
cd /tmp/
sudo dapperstrano autopilot execute workstation-node-install-code-data.php
sudo chown -R www-data /opt/jrush/jrush/current/src
sudo rm workstation-node-install-code-data.php
SSHDATA;
  }
